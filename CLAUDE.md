...
Forked from `../zz_cli_avatars/` (v0.4). Full vision: `../10 - Projects/AI Avatar Room - Design.md`. Full Stage 1 implementation plan (Fable draft → Opus-verified final): `STAGE1_PLAN.md`. Shared history/architecture reference: `../zz_cli_avatars/CLAUDE.md`.
